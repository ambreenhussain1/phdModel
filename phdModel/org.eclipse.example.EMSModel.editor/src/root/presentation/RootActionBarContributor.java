...
/**
 * This is the action bar contributor for the Root model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RootActionBarContributor
	 ...
	 * @generated
	 */
	public RootActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("root-settings"));
		toolBarManager.add(new Separator("root-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(TestEditorPlugin.INSTANCE.getString("_UI_RootEditor_menu"), "rootMenuID");
