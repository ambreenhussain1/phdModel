...
/**
 * This is the item provider adapter for a {@link root.Test} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Test_att1_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Test_att1_feature", "_UI_Test_type"),
				 RootPackage.Literals.TEST__ATT1,
				 true,
				 false,
				 false,
	...
	protected void addAtt2PropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Test_att2_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Test_att2_feature", "_UI_Test_type"),
				 RootPackage.Literals.TEST__ATT2,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RootPackage.Literals.TEST__NAME,
				 true,
				 false,
				 false,
